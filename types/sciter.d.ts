...
interface Element extends Node, Behaviors {
    ...
    post(eventOrHandler: (this: Element, ...any) => void | Event, avoidDuplicates?: boolean): boolean
    ...
    */
    ...
    /**
     * subscribe and perform the event only once
     * @param event `^name` for handling events in capturing phase
     * @param query subscribe to all children that match the css selector otherwise this element
     * @param handler `Function(Event, Element)` - `this` is set to the element the handler is attached to
     */
    once(event: keyof typeof eventType, query: string, handler: eventFunction): Element
    once(event: keyof typeof eventType, handler: eventFunction): Element
     ...
     *  The element gets unsubscribed automatically when it is disconnected from DOM
        ...
        @param handler `Function(Event, Element)` - `this` is set to the element the handler is attached to
    */
    onGlobalEvent(event: string, handler: (this: Element, ...any) => void): Element
    /** Unsubscribe this element from particular event, if no argument is provided unsubscribe from all events */
    offGlobalEvent(eventOrHandler?: string | ((this: Element, ...any) => void)): Element
    ...
    timer(milliseconds: number, callback: (this: Element, ...any) => void | boolean): boolean
    ...
    paintBackground: (Graphics) => void
    /** Immediate mode drawing "ports".
     *  Functions assigned to these properties will be called when the element is rendered on screen
     *  so they can draw anything on top (or below) of default HTML/CSS rendering. */
    paintForeground: (Graphics) => void
    /** Immediate mode drawing "ports".
     *  Functions assigned to these properties will be called when the element is rendered on screen
     *  so they can draw anything on top (or below) of default HTML/CSS rendering. */
    paintContent: (Graphics) => void
    /** Immediate mode drawing "ports".
     *  Functions assigned to these properties will be called when the element is rendered on screen
     *  so they can draw anything on top (or below) of default HTML/CSS rendering. */
    paintOutline: (Graphics) => void
    ...
    append(JSX: JSX): void
    /** Draw elements that are not connected with DOM */
    attach(disconnectedElement: Element): void
    ...
    scrollBy(options: { left?: number; top?: number; behavior?: "instant" | "smooth" }): void
    scrollTo(x: number, y: number): void
    scrollTo(options: { left?: number; top?: number; behavior?: "instant" | "smooth" }): void
    scrollIntoView(toTop?: true): void
    scrollIntoView(options: { block?: "start" | "nearest"; behavior?: "instant" | "smooth" }): void
...
interface State {
     ...
     */
    box(
        property: "xywh" | "rect" | "position" | "dimension",
        metric: keyof typeof boxMetric,
        relativeTo?: keyof typeof boxRelativeTo,
        asPpx?: boolean
    ): number[]
    box(
        property: keyof typeof boxProperties,
        metric: keyof typeof boxMetric,
        relativeTo?: keyof typeof boxRelativeTo,
        asPpx?: boolean
    ): number
...
type eventFunction = (Event, Element) => void
enum eventType {
    ready,
    complete,
...
interface Request {
     ...
     * @version 5.0.1.1+ */
    abort(): void
    /** Forcing cancelation of running tasks
     * @version 5.0.3.8+ */
    cancel(): void
...
interface Image {
    ...
    compose(
        src: Image,
        operation: keyof typeof composeOps,
        dstX?: number,
        dstY?: number,
        srcX?: number,
        srcY?: number,
...
declare module "@sys" {
    ...
    interface Dir extends AsyncIterable<string> {
        close()
        path: string
    }
...
interface Window {
    ...
    screenBox(
        type: keyof typeof screenBoxType,
        property: "xywh" | "rect" | "position" | "dimension",
        asPpx?: boolean
    ): number[]
    ...
    box(
        property: "xywh" | "rect" | "position" | "dimension",
        metric: keyof typeof windowBoxMetric,
        relativeTo?: keyof typeof windowBoxRelativeTo,
        asPpx?: boolean
    ): number[]
    box(
        property: keyof typeof boxProperties,
...
declare var Window: {
    ...
    screenBox(
        screen: number,
        type: keyof typeof screenBoxType | "devicePixelRatio",
        property?: "xywh" | "rect" | "position" | "dimension"
    ): number[]
    screenBox(
        screen: number,
...
enum windowBoxMetric {
    "border",
    "client",
    "cursor",
    "caret"
}
enum windowBoxRelativeTo {
    "desktop",
    "monitor",
    "self"
}
