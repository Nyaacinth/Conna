...
const entries = ["main.htm", "main.html", "index.htm", "index.html"]
...
if (entry === undefined) {
    console.error(
        "\u001B[31mNo main file neither in package json nor in standard entries.\u001B[0m Options are:",
        entries
    )
    process.exit(1)
}
